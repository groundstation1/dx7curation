...
function render(): void {
  ...
  wrap.appendChild(el('div', { class: 'panel' },
    ...
    el('div', { class: 'row', style: { justifyContent: 'center', marginTop: '16px' } },
      ...
      el('button', { class: 'btn', onclick: () => void choose('a') }, 'Keep A'),
      el('button', { class: 'btn', onclick: () => void choose('b') }, 'Keep B'),
    ...
    el('div', { class: 'keyhelp' },
      ...
      el('span', {}, el('kbd', {}, '1'), ' / ', el('kbd', {}, '2'), ' pick a keeper'),
      el('span', {}, el('kbd', {}, '3'), ' keep both'),
